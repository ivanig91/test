...
public class PantallaJuego2 extends PantallaJuego implements Screen {
    ...
    public void show() {
        ...
        if(jugador==null){
            ...
            fondo = new Fondo(new Texture(Constantes.IMAGEN_FONDO2),moverFondo,0,rotaFondo);
            moverFondoAux=fondo.getFondo().getWidth();
            fondoAux = new Fondo ( new Texture(Constantes.IMAGEN_FONDO2),moverFondoAux,0,rotaFondo);
            marcianos = new Array<>();
            ...
            backSong = Gdx.audio.newSound(Gdx.files.internal("sounds/zhu-faded.mp3"));
            backSong.play();
            stateTime= 0f;
